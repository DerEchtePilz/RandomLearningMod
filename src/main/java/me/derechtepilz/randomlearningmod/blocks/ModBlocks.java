...
public class ModBlocks {
    ...
    public static void registerBlocks() {
        Registry.register(Registry.BLOCK, new Identifier(RandomLearningModClient.MOD_ID, "cobalt_ore"), COBALT_ORE);
        Registry.register(Registry.BLOCK, new Identifier(RandomLearningModClient.MOD_ID, "cobalt_block"), COBALT_BLOCK);
    }
}
